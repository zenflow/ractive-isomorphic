...
var site_options = {
	...
	_trackRouteExecution: function(){
		...
		var promises = [];
		if (self._promise){
			promises.push(self._route_waiter.wrap(self._promise));
			delete self._promise;
		}
		if (self.page._promise) {
			promises.push(self._route_waiter.wrap(self.page._promise));
